          ...
          <div className="p-5">
            <div className="grid lg:grid-cols-2 gap-10 mb-10  ">
              <div className="">
                ...
                <p className="text-lg flex text-justify text-[#4f7853] mt-6">
                  In modern computing, the concept of "virtual" encompasses both
                  the essence of existence and the realm of simulation.
                  Virtualization transforms the capabilities of a single
                  computer, allowing it to manifest as multiple entities, each
                  with its distinct operating system and hardware resources.
                  Through the magic of virtualization, a solitary machine can
                  simulate an entire array of computers, all while sharing the
                  central processing unit (CPU) and input/output (I/O)
                  facilities. These simulated machines are aptly termed as
            ...
            <div className="grid lg:grid-cols-2 gap-5 mb-5 p-2 sm:gap-10 sm:mb-10 sm:p-5">
              ...
              <div>
                ...
                <p className="text-base sm:text-lg text-justify text-[#4f7853] mt-2 sm:mt-3">
                  ...
                  turn to use the operating system. The term “preemption”
                  implies the ability of interrupting a task, switching to
                  another one, and then resuming the first task at a later time.
                  The term “multitasking”, on the other hand, refers to the
                  ability to run simultaneous processes in a given time unit.
                  Processes that run in an operating system is not the only way
                  to perform several operations at the same time. This activity
                  could be done with the use of simultaneous subtasks called{" "}
            ...
            <div className="grid lg:grid-cols-2 gap-5 mb-5 p-2 sm:gap-10 sm:mb-10 sm:p-5">
              <div>
                ...
                <p className="text-base sm:text-lg text-justify text-[#4f7853] mt-2 sm:mt-3">
                  ...
                  that contains multiple processors (“cores”) in a single
                  integrated circuit. Virtually, all microprocessors today in
                  desktops and servers are multicore and are used to run a
                  ...
                  <br />
                  <br />
                  Flynn’s Taxonomy, which was proposed in 1966, is one of the
                  categorizations of parallel hardware is still used today. It
                  was based on the number of instruction streams and the number
                  of data streams.
                </p>
              </div>
              <div className="border-4 border-white rounded-xl shadow-xl border-none mb-5 p-2 sm:p-5">
                ...
                <div className="grid gap-3 sp-2 mt-10 sm:gap-10 sm:mb-10 sm:p-5 lg:grid-cols-2">
                  <div className="border-white rounded-xl shadow-xl">
                    ...
                    <p className="text-sm text-center text-[#4f7853] mt-2 mb-3 sm:text-base sm:mt-3 sm:mb-4 md:text-lg md:mb-5">
                      By marking specific sections of code as "protected,"
                      synchronization ensures that resources are accessed by
                      only one thread at a time. This prevents simultaneous
                      execution that could compromise shared data integrity.
                    </p>
                  </div>
                  <div className="border-white rounded-xl shadow-xl">
                    <h1 className="text-xl font-bold text-center mb-2 text-[#4f7853] sm:text-2xl sm:mb-3">
            ...
            <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-5 mb-14 mt-2">
              <div className="p-5 border-2 border-white rounded-xl shadow-xl">
                ...
                <p className="text-base sm:text-lg text-justify text-[#4f7853] mt-2 sm:mt-3">
                  <strong>• Concurrency </strong> is defined as “the perception
                  of having tasks that run at the same time.”
                  <br />
                  <br />
                  <strong>• Parallelism </strong> are tasks that literally run
                  at the same time.
                  <br />
                  <br />
                  <strong>• </strong> Parallelism is a subset of concurrency.
                </p>
                ...
                <p className="text-base sm:text-lg text-justify text-[#4f7853] mt-2 sm:mt-3">
                  <strong>• Data Race </strong> is defined as “the perception of
                  having tasks that run at the same time.”
                  <br />
                  <br />
                ...
                <p className="text-base sm:text-lg text-justify text-[#4f7853] mt-2 sm:mt-3">
                  ...
                  It is about marking specific parts of the code as “protected”
                  so that two (2) or more concurrent threads will not execute
                  the code simultaneously, which screws up the shared data.
                  <br />
                  <br />
              ...
              <div className="p-5 border-2 border-white rounded-xl shadow-xl ">
                ...
                <p className="text-base sm:text-lg flex text-justify text-[#4f7853] mt-4">
                  ...
                  computer clusters and “grids,” multiprocessor SMP computers,
                  and multi-core PCs
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-2 p-2 mt-20  sm:mb-10 sm:p-5 lg:grid-cols-2 border-white rounded-xl shadow-xl">
              <div>
                ...
                <p className="text-base justify text-[#4f7853] mt-2 sm:text-lg sm:mt-3">
                  ...
                  that many functions of an organization’s data center can be
                  moved to services on the Internet, which is “in the cloud.” In
                  its simplest form, cloud service provides off-site storage
            ...
            <div className="grid gap-3 sp-2 mt-10 sm:gap-10 sm:mb-10 sm:p-5 lg:grid-cols-2">
              <div className="border-white rounded-xl shadow-xl p-5">
                ...
                <p className="text-sm text-justify text-[#4f7853] mt-2 mb-3 sm:text-base sm:mt-3 sm:mb-4 md:text-lg md:mb-5">
                  <strong>•</strong> The client’s data center is simplified and
                  the cost is reduced.
                </p>
                <p className="text-sm text-justify text-[#4f7853] mt-2 mb-3 sm:text-base sm:mt-3 sm:mb-4 md:text-lg md:mb-5">
              ...
              <div className="border-white rounded-xl shadow-xl p-5">
                ...
                <p className="text-sm text-justify text-[#4f7853] mt-2 mb-3 sm:text-base sm:mt-3 sm:mb-4 md:text-lg md:mb-5">
                  ...
                  or data theft can compromise a client organization’s future
                </p>
                <p className="text-sm text-justify text-[#4f7853] mt-2 mb-3 sm:text-base sm:mt-3 sm:mb-4 md:text-lg md:mb-5">
            ...
            <div className="grid gap-2 p-5 mt-10  sm:mb-10 sm:p-5 lg:grid-cols-2 border-white rounded-xl shadow-xl">
              <div>
                ...
                <p className="text-base justify text-[#4f7853] mt-2 sm:text-lg sm:mt-3">
                  ...
                  processors that allows programmers to bypass GPU’s graphics
                  API and graphics interfaces.
                </p>
              </div>
              <div className="border-none mb-5 sm:p-5">
                <Image
