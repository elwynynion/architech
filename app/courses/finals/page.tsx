  ...
  return (
    <div className="bg-[#FFFEFA] h-[100vh]">
      <div className="container px-5">
        ...
        <div className="border-4 border-[#4F7853] rounded-[35px] p-10 max-[450px]:p-0 max-[450px]:border-0">
          ...
          <div className="font-bold text-[#4F7853] text-4xl mt-12 mb-3">
            Storage Device
          </div>
          ...
          <ul className="text-[#4F7853] text-xl tracking-wide text-justify list-disc px-12">
            <li className="mt-5">
              ...
              any point on the storage medium, like a hard disk or CD-ROM.
              It&apos;s fast because it can quickly locate and access specific
              records or files.
            </li>
            <li className="mt-5">
              ...
              data before it. This can be slow, so it&apos;s mainly used for
              tasks like backup and batch processing, where speed isn&apos;t
              critical.
            </li>
            <li className="mt-5">
          ...
          <div className="bg-[#FAF6F9] mb-[10px] rounded-[20px] mt-20 p-6 pb-4 shadow-xl">
            ...
            <ul className="text-[#4F7853] text-xl tracking-wider text-justify list-disc mt-6">
              <p>
              ...
              <li className="mt-2">
                <span className="font-bold">Secondary Storage</span> it doesn
                {"'"}t have direct accessibility to the CPU. It uses input and
                output channels to connect to the computer, mainly external. It
                is non-volatile and has a larger storage capacity compared to
          ...
          <div className="mt-20">
            ...
            <div className="text-[#4F7853] text-xl tracking-wider text-justify list-disc mt-6">
            ...
            <div className="text-[#4F7853] text-xl tracking-wider text-justify list-disc mt-6">
              ...
              distinguishing between 1&apos;s and 0&apos;s. A drive motor
              rotates the disk platter(s), while an arm with a read/write head
              services the surfaces of adjoining platters.
            </div>

            <ul className="text-[#4F7853] text-xl tracking-wider text-justify list-disc ml-4">
              <li className="mt-2">
            ...
            <p className="text-[#4F7853] text-xl tracking-wider text-justify list-disc mt-8 pr-12">
            ...
            <div className="text-[#4F7853] text-xl tracking-wider text-justify list-disc ml-5 mt-12 pr-12">
              ...
              <p className="mt-12">
                ...
                memory&apos;s compact size, low power consumption, and
                lightweight nature make it well-suited for secondary storage in
                both long-term system storage and portable devices. These
          ...
          <div className="p-7">
            ...
            <p className="text-[#4F7853] text-xl tracking-wider text-justify list-disc ">
              ...
              <div className="grid grid-cols-1 md:grid-cols-[55%,40%] gap-x-[40px] gap-y-[30px] place-items-start md:place-items-center mt-4 p-4">
                <div className="text-[#4F7853] text-xl tracking-wide">
                  ...
                  <p className="text-justify">
                    ...
                    pictures and television programs (hence the name
                    &quot;digital video disc&quot;). Though read-only,
                    recordable, and even erasable and rewritable versions can be
                    used on personal computers to store large quantities of
                    almost any kind of data (hence &quot;digital versatile
                    disc&quot;).
                  </p>
                </div>
          ...
          <div className="text-[#4F7853] text-xl tracking-wider text-justify list-disc">
            <div className="font-bold text-2xl ">Magnetic Tapes </div>
            <div className="text-[#4F7853] text-xl tracking-wider text-justify list-disc mt-4">
            ...
            <ul className="text-[#4F7853] text-xl tracking-wider text-justify list-disc mt-2 ml-6">
              <li>
              ...
              <div className="grid grid-cols-1 md:grid-cols-[40%,55%] gap-x-[40px] gap-y-[30px] place-items-start md:place-items-center p-4">
                ...
                <div className="text-[#4F7853] text-xl tracking-wide">
                  ...
                  <p className="text-justify">
                    ...
                    computer&apos;s motherboard. PATA was widely used in
                    personal computers before being largely replaced by Serial
                    ATA (SATA) in the mid-2000s.
                  </p>
                  <p className="text-justify">
              ...
              <div className="grid grid-cols-1 md:grid-cols-[55%,40%] gap-x-[40px] gap-y-[30px] place-items-start md:place-items-center mt-4 p-4">
                <div className="text-[#4F7853] text-xl tracking-wide">
                  ...
                  <p className="text-justify">
                    ...
                    hard drives and solid-state drives (SSDs) to a
                    computer&apos;s motherboard. It replaced the older Parallel
                    ATA (PATA) interface due to its superior performance and
                    efficiency. SATA uses a serial communication method, which
                    means data is transmitted one bit at a time over a single
                    wire, whereas PATA used parallel communication, transmitting
          ...
          <div className="bg-[#FAF6F9] mb-[10px] rounded-[20px] p-4 mt-20 pb-4 shadow-xl">
            <div className="font-bold text-[#4F7853] text-3xl mb-3">
              Hierarchy of Storage
            </div>
            <ul className="text-[#4F7853] text-xl tracking-wider text-justify list-disc">
              <li className="mt-2">
          ...
          <div className="mt-20">
            ...
            <div className="text-[#4F7853] text-xl tracking-wider text-justify list-disc mt-10">
            ...
            <div className="text-[#4F7853] text-xl tracking-wider text-justify list-disc mt-[80px]">
              <span className="font-bold">
