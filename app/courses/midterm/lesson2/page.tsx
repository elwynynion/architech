      ...
      <div className="container px-5">
        ...
        <div className="border-4 max-[450px]:border-0 border-[#4F7853] rounded-[35px] p-10 max-[450px]:p-0">
          ...
          <div className="bg-[#FAF6F9] mt-20 mb-[10px] rounded-[20px] p-8 shadow-xl">
            ...
            <p className="text-[#4F7853] text-xl tracking-wide text-justify list-disc ml-6 pr-8">
              This is a volatile type of memory. It is called &quot;random
              access&quot; because any storage location can be accessed
              directly.
            </p>
          ...
          <p className="text-[#4F7853] text-2xl tracking-wide text-justify list-disc mt-6 px-8">
            From the term, information can be &quot;read&quot; only from this
            type of memory. It holds information permanently even while there is
            no power to the ROM. It is a nonvolatile type of memory
          </p>
          ...
          <div className="p-7">
            ...
            <div className="grid grid-cols-2 max-[700px]:grid-cols-1 gap-x-[50px] gap-y-[20px] w-[100%] h-full p-2 mt-8">
              ...
              <p className="text-[#4F7853] text-xl p-2">
                ...
                <br />
                If your CPU can&apos;t keep up with demanding tasks, it becomes
                a bottleneck.
              </p>
              <p className="text-[#4F7853] text-xl p-2">
                {" "}
          ...
          <div className="p-7">
            ...
            <div className="text-[#4F7853] text-xl tracking-wider text-justify list-disc ml-5">
              ...
              slowdowns, known as &apos;thrashing.&apos; Despite its
              shortcomings, virtual memory remains an important component for
              executing resource-intensive programs and providing multitasking
              capabilities.
            </div>
          </div>
          ...
          <div className="bg-[#FAF6F9] mt-20 mb-[10px] rounded-[20px] p-8 shadow-xl">
            ...
            <p className="text-[#4F7853] text-xl tracking-wider text-justify list-disc ml-5">
              ...
              reference is also called &quot;caching.&quot; Its characteristics
              include increased capacity, decreased latency, and cache
              availability. Caching thus becomes a vital component in maximizing
