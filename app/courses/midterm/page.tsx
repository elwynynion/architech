        ...
        <div className="border-4 border-[#4F7853] rounded-[35px] p-10  max-[460px]:border-none max-[460px]:p-2">
          ...
          <div className="grid grid-cols-2 max-[1330px]:grid-cols-1 gap-x-[50px] gap-y-[30px]">
            ...
            <div className="border-[0px] rounded-[20px] bg-[#DDEEDF] w-full mb-5 flex max-[700px]:w-full max-[700px]:flex-col shadow-xl">
              ...
              <div className="w-[60%] p-4 max-[700px]:w-full">
                ...
                <p className="text-[#4F7853] text-xl text-justify max-[460px]:text-[18px]">
                  Computer&apos;s short-term memory. It&apos;s the temporary
                  memory space inside a computer that allows it to stores data
                  and instructions that the CPU needs to access quickly. RAM
            ...
            <div className="border-[1px] rounded-[20px] bg-[#DDEEDF] max-w-[700px] w-full mb-5 flex max-[700px]:flex-col shadow-xl">
              ...
              <div className="w-[60%] p-4 max-[700px]:w-full">
                ...
                <p className="text-[#4F7853] text-xl text-justify max-[460px]:text-[18px]">
                  ...
                  computer processing and recording. It&apos;s widely used for
                  voice calls, video conferencing, recording, speech
                  recognition, and other audio tasks, enabling communication and
                  interaction with software requiring audio input.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 max-[700px]:grid-cols-1">
                ...
                <div className="p-4">
                  ...
                  <p className="text-[#4F7853] text-xl text-justify">
                    ...
                    &quot;Fleming valve&quot; in 1904. This device was
                    essentially a diode, allowing current to flow in only one
                    direction.
                  </p>
                  <p className="text-[#4F7853] text-xl text-justify mt-4">
                    <span className="font-bold">History </span>After
                    Fleming&apos;s invention, Lee De Forest, an American
                    inventor, further developed the vacuum tube by introducing
                    the &quot;audion&quot; in 1906. The Audion was the first
                    device capable of amplifying electrical signals, paving the
                    way for numerous applications in radio communication,
                    broadcasting, and early computing.
                  </p>
                  <p className="text-[#4F7853] text-xl text-justify mt-4">
              ...
              <div className="grid grid-cols-2 max-[700px]:grid-cols-1">
                ...
                <div className="p-4">
                  ...
                  <p className="text-[#4F7853] text-xl text-justify">
                    ...
                    connected on a single chip. Kilby&apos;s integrated circuit
                    laid the foundation for modern semiconductor technology.
                    <br />
                    ...
                    of the integrated circuit. Noyce&apos;s integrated circuit
                    used silicon as the substrate material and incorporated
                    multiple transistors and other components on a single chip.
                    His design was more practical for mass production and became
                    the basis for the integrated circuits used in modern
                    electronics.
                  </p>
                  <p className="text-[#4F7853] text-xl text-justify mt-4">
              ...
              <div className="grid grid-cols-2 max-[700px]:grid-cols-1">
                ...
                <div className="p-4">
                  ...
                  <p className="text-[#4F7853] text-xl text-justify">
                    ...
                    which was released in 1971. The Intel 4004 was the
                    world&apos;s first microprocessor, paving the way for the
                  ...
                  <p className="text-[#4F7853] text-xl text-justify mt-4">
                    ...
                    device, acting as its &quot;brain.&quot; It handles data
                    processing, instruction execution, control, arithmetic,
                    logic operations, interrupt handling, and clock
                    synchronization, ensuring efficient system operation..
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 max-[700px]:grid-cols-1">
                ...
                <div className="p-4">
                  ...
                  <p className="text-[#4F7853] text-xl text-justify">
                    ...
                    In 1950, Turing proposed the &quot;Turing Test&quot; in his
                    paper titled &quot;Computing Machinery and
                    Intelligence,&quot; which was published in the journal Mind.
                    The Turing Test is a criterion for evaluating a
                    machine&apos;s ability to exhibit intelligent behavior
                    equivalent to, or indistinguishable from, that of a human.
                    While Turing&apos;s work laid the theoretical groundwork for
                    AI, the practical development of AI technologies involved
                    contributions from numerous researchers and continues to
                    evolve to this day.
                  </p>
                  <p className="text-[#4F7853] text-xl text-justify mt-4">
                    <span className="font-bold">Uses </span>Transistors act as a
          ...
          <div className="p-7">
            ...
            <div className="grid grid-cols-2 max-[700px]:grid-cols-1 gap-x-[50px] gap-y-[40px] w-[100%] h-full p-2">
              ...
              <p className="text-[#4F7853] text-xl p-2">
                ...
                term &quot;artificial intelligence&quot; in 1956 and developed
                the first AI programming language, LISP, in the 1960s. Early AI
                systems focused on rule-based approaches and symbolic reasoning.
              </p>
              <p className="text-[#4F7853] text-xl p-2">
                {" "}
                <span className="font-bold text-[#4F7853] text-2xl">
                ...
                as the &quot;AI winter.&quot; Progress was slower than
                anticipated, and funding for AI research declined due to
                unrealistic expectations and disappointments with early AI
                systems.
              </p>
              <p className="text-[#4F7853] text-xl p-2">
                {" "}
          ...
          <div className="grid grid-cols-1 max-[1330px]:grid-cols-1">
            <div className="grid grid-cols-1 md:grid-cols-[55%,40%] gap-x-[40px] gap-y-[30px] place-items-start md:place-items-center mt-4 p-4">
              <p className="text-[#4F7853] text-xl tracking-wide text-justify pl-4 pr-4">
                ...
                &quot;brain&quot; of the system, executing instructions,
            ...
            <div className="grid grid-cols-1 md:grid-cols-[40%,55%] gap-x-[40px] gap-y-[30px] place-items-start md:place-items-center p-4">
              ...
              <div className="text-[#4F7853] text-xl tracking-wide">
                ...
                <p className="text-justify">
                  ...
                  instructions, processing data, and coordinating the operation
                  of the entire system to achieve desired functionality
          ...
          <div className="bg-[#FAF6F9] mb-[10px] rounded-[20px] mt-20 p-6 pb-4 shadow-xl">
            ...
            <ul className="text-[#4F7853] text-xl tracking-wide text-justify list-disc ml-6 pr-4">
              <p>
                ...
                system. It is often referred to as the &quot;brain&quot; of the
                computer. The CPU interprets and executes instructions fetched
                from the computer&apos;s memory, processes data, and coordinates
                input and output operations. It consists of various components,
                including arithmetic logic units (ALUs), control units, and
                registers, all integrated onto a single chip.
              </p>
              <li className="mt-2">
                ...
                electrical signals. It takes input from the CPU&apos;s registers
                or memory, processes the data according to the instructions
                provided by the CPU&apos;s control unit, and produces output
                results.
              </li>
              <li className="mt-2">
                <span className="font-bold">Control Unit (CU)</span> The Control
                Unit (CU) is a vital component of a computer&apos;s Central
                Processing Unit (CPU), serving as its &quot;traffic
                controller.&quot; Its primary functions include fetching
                instructions from memory, decoding them to determine operations,
                coordinating instruction execution, managing data movement
                within the CPU and between memory and input/output devices, and
                generating control signals to synchronize CPU operations.
                Essentially, the CU ensures that instructions are executed
                correctly and efficiently, orchestrating the CPU&apos;s
                operation.
              </li>
            </ul>
          </div>
          ...
          <ul className="text-[#4F7853] text-xl tracking-wide text-justify list-disc mx-6 px-8">
            <li className="mt-5">
              ...
              data between a computer&apos;s memory and its CPU, which operates
              as the device&apos;s &quot;engine&quot;. It carries the data
              between the processor and other components. Bus controllers manage
              component information interchange speed and the data being carried
              on a data bus might be parallel or serial.
            </li>
            <li className="mt-5">
            ...
            <li className="mt-5">
              ...
              manages the communication between the computer&apos;s CPU and its
              other components. The signal ensures that the operations are
              carried out in the correct sequence and at the right time. The
              control bus also carries the clock&apos;s pulses, and the Control
          ...
          <ul className="text-[#4F7853] text-xl tracking-wide text-justify list-disc ml-6 pr-8">
            <li className="mt-2">
              <span className="font-bold">Fetch </span> It is designed to fetch
              several instructions at a time in parallel
            </li>
            <li className="mt-2">
            ...
            <li className="mt-2">
              <span className="font-bold">Execute </span> It executes the part/s
