          ...
          <div className="p-5 max-[450px]:p-0">
            <div className="grid lg:grid-cols-2 gap-10 mb-10  ">
              <div className="">
                ...
                <p className="text-lg flex text-justify text-[#4f7853] mt-6">
                  ...
                  that is represented in a set of bits ones and zeros. Wires and
                  circuits bring forth these bits as electrical pulses in the
                  computer system. These bits can be a file, information, or
                  instruction.
                </p>
                <p className="text-lg flex text-justify text-[#4f7853] mt-6">
            ...
            <div className="grid gap-5 p-2 mt-20 sm:gap-10 sm:mb-10 sm:p-5 lg:grid-cols-2">
              ...
              <div className="border-white rounded-xl shadow-xl p-5">
                ...
                <p className="text-base text-justify text-[#4f7853] mt-2 sm:text-lg sm:mt-3">
                  It provides additional information about a certain items
                  content. The other terms for metadata are descriptions,
                  keywords, tags. (Example: JPEG dimensions, date created, date
                  accessed, color depth, etc.)
                </p>
              </div>
            </div>
